...
export const metadata: Metadata = {
  title: "IT Solutions & Services | TechVision",
  description: "Enterprise IT services including cloud infrastructure, cybersecurity, custom software development, and AI solutions. Transform your business with innovative technology.",
  keywords: "IT services, cloud solutions, cybersecurity, software development, enterprise technology",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "IT Solutions & Services | TechVision",
    description: "Enterprise IT services and digital transformation solutions for businesses worldwide.",
    type: "website",
    siteName: "TechVision"
  }
};
